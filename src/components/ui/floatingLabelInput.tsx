...
>(({ className,id, label, ...props }, ref) => {
  return (
    <div className="relative">
      <FloatingInput className='autofill:shadow-[inset_0_0_0px_1000px_theme(colors.white)]' ref={ref} id={id} {...props} />
      <FloatingLabel className={className} htmlFor={id}>{label}</FloatingLabel>
    </div>
  );
});
